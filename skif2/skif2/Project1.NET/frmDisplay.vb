...
Friend Class frmDisplay
	...
	Private Sub startExperiment()
		...
		If sTraining = 0 Then ' No PreCueing
			expImage1.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & "blank.bmp")
			expImage2.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & sStimCueFilename)
			expImage3.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & sStimCueFilename)
		ElseIf (sTraining < 0) Then 
			expImage1.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & sPreCueFilename)
			expImage2.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & sStimCueFilename)
			expImage3.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & sStimCueFilename)
		ElseIf (sTraining > 0) Then 
			expImage1.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & "blank.bmp")
			expImage2.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & sStimulusFilename)
			expImage3.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & picPath & sStimCueFilename)
		End If
	...
	Private Sub writeData()
		...
		filedata = OpenAppend(outPutFile_Training)
	...
	Private Sub frmDisplay_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmDisplay_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
		Dim KeyCode As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
	...
	Private Sub frmDisplay_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	'UPGRADE_WARNING: Form event frmDisplay.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
	Private Sub frmDisplay_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
		bDisplayed = False
		iResponse = 0
	...
	'UPGRADE_WARNING: Event frmDisplay.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmDisplay_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
		'Me.
		'txtDebug.Text = sDir
