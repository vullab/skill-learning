...
Begin VB.Form frmInference 
   ...
   End
End
Attribute VB_Name = "frmInference"
...
Dim iStimOrd(1 To 4) As Integer
...
sStimulusFilename = "_" & sStimPic(iStim) & ".bmp"
    ...
    expImage1.Picture = LoadPicture(App.path & picPath & "blank.bmp")
    expImage2.Picture = LoadPicture(App.path & picPath & sPreCueFilename)
    expImage3.Picture = LoadPicture(App.path & picPath & sPreCueFilename)
