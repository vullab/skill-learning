...
class Timer:
	...
	def getreltime(self, eventname, relativeto):
		return self.events[eventname] - self.events[relativeto]
		
	def getreltimes(self, eventnames, relativeto):
		outpt = dict()
		for v in eventnames:
			outpt[v] = self.getreltime(v, relativeto)
		return outpt
